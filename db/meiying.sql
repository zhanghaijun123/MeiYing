...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '参数配置表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_config` VALUES (4, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'true', 'Y', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '是否开启注册用户功能（true开启，false关闭）');
...
CREATE TABLE `sys_dept`  (
  ...
  `ancestors` varchar(50) CHARACTER SET utf8 COLLATE utf8_esperanto_ci NULL DEFAULT '' COMMENT '祖级列表',
...
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '部门表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '字典数据表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '字典类型表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES ('100', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2020-09-27 13:47:36');
INSERT INTO `sys_logininfor` VALUES ('101', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-09-27 13:47:40');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1062 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '菜单权限表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '岗位信息表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_esperanto_ci COMMENT = '角色信息表' ROW_FORMAT = Compact;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-09-27 13:47:41', 'admin', '2018-03-16 11:33:00', 'ry', '2020-09-27 13:47:40', '管理员');
